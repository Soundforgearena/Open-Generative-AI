 ...
 *   - Checkout redirects customers to Stripe's hosted page from a server-side
 *     session URL, so this deployment does not require a browser publishable
 *     key to accept payments.
 *
